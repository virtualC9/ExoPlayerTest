...
public class LikeAdaptr extends RecyclerView.Adapter<LikeAdaptr.ViewHolder> {
    ...
    public LikeAdaptr(Context context, List<Channel> list) {
        mList = list;
    ...
    //填充视图
    @Override
    public void onBindViewHolder(@NonNull final LikeAdaptr.ViewHolder holder, final int position) {
        holder.mView.setText(mList.get(position).getName());
        holder.imageView.setImageDrawable(context.getDrawable(R.mipmap.delete));
        //添加点击监听事件
